 ...
 * @author Admin
 */
public class HT_Loading extends javax.swing.JFrame {

    int i = 0;
    Timer t;
    public static boolean isDangXuat = true;
    HT_Loading ManHinhChaoFrm = this;
    /**
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 830, 400));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HT_Loading.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
