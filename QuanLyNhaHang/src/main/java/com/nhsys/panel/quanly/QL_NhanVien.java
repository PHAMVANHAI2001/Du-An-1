...
public class QL_NhanVien extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cboLoctheochucvu.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Sắp xếp theo chức vụ", "Quản lý", "Lễ tân", "Nhân viên phục vụ", " " }));
...
//    }
    ...
    boolean checkVal() {
        ...
        for (int i = 0; i < tblNhanVien.getRowCount(); i++) {
            if (tblNhanVien.getValueAt(i, 0).equals(txtMaNV.getText())) {
