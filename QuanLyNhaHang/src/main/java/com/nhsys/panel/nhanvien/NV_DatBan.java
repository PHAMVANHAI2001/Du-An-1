...
public class NV_DatBan extends javax.swing.JPanel {
    ...
    boolean checkVal() {
        ...
        if (txtMaDatBan.getText().isEmpty() || txtMaDatBan.getText().equalsIgnoreCase("") || txtMaDatBan.getText().equalsIgnoreCase("Mã đặt bàn")) {
        ...
        if (txtTenKH.getText().isEmpty() || txtTenKH.getText().equalsIgnoreCase("") || txtTenKH.getText().equalsIgnoreCase("Tên Khách Hàng")) {
            MsgBox.alert(this, "Bạn chưa nhập tên khách hàng!");
            return false;
        }
        if (txtSDT.getText().isEmpty() || txtSDT.getText().equalsIgnoreCase("") || txtSDT.getText().equalsIgnoreCase("Số Điện Thoại")) {
        ...
        try {
            ...
            if (txtSDT.getText().length() > 10) {
                MsgBox.alert(this, "Số điện thoại không được > 10 số!");
                return false;
            }
        } catch (Exception e) {
        ...
        if (txtGioDat.getText().isEmpty() || txtGioDat.getText().equalsIgnoreCase("") || txtGioDat.getText().equalsIgnoreCase("Giờ Đặt")) {
        ...
        if (txtSoNguoi.getText().isEmpty() || txtSoNguoi.getText().equalsIgnoreCase("") || txtSoNguoi.getText().equalsIgnoreCase("Số Người")) {
